...
package com.xtdstudios.DMT
{
	...
	//			throw new IllegalOperationError("Group already exist");
		...
		protected function loadAtlases(assetsGroupName: String):void
		{
			...
			assetsGroup.addEventListener(AssetGroupEvent.TEXTURES_RESTORED, onAtlasesTexturesRestored);
		...
		protected function onAtlasesTexturesRestored(e:AssetGroupEvent):void
		{
