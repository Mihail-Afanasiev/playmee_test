...
package com.xtdstudios.DMT.atlas
{
	...
	public class Atlas extends EventDispatcher implements ISerializable
	{
		...
		private var m_atfData		: ByteArray;
		...
		public function decodeResource(data:ByteArray):void
		{
			if (data == null)
			{
				throw new Error("Null picture data");
				return;
			}
		...
		public function decodeAtf(atfBytes:ByteArray):void
		{
			m_atfData = atfBytes;
